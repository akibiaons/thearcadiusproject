...
const cardDetails = [
  {
    ...
    description:
      "I deeply enjoy solving problems through coding. From the frontend all the way to the backend and the API's in between. No project is too challenging for me to handle.",
    tools: [
      "JavaScript",
      "Node.JS",
      "React",
          ...
          >
            ...
            <div className="grid grid-cols-3 gap-2 mt-10">
              {cardDetail.tools.map((tool, index) => (
                ...
                >
                  <p className="text-xs ml-2 text-[#888889] font-mono font-semibold uppercase">
                    {tool}
                  </p>
                </div>
              ))}
